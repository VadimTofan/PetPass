    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          name, email address, pet details, and profile picture. We may also
          collect technical information like device type and app usage.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          trusted third parties to provide services such as authentication,
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          be reflected on this page, with the updated date at the top.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          ...
          at <strong>not@avaliable.yet</strong>.
        </p>
      </section>
    </div>
  );
