  ...
  const sections = [
    {
      ...
      content:
        "By accessing or using PetPass, you agree to these Terms of Service and our Privacy Policy. If you do not agree, please do not use our app.",
    },
    {
    ...
    },
    {
      ...
      content:
        "You agree to use PetPass only for lawful purposes. You must not post or transmit any content that is harmful, offensive, or infringes on the rights of others.",
    },
    {
    ...
    },
    {
      ...
      content:
        "PetPass is provided 'as is' without warranties of any kind. We are not liable for any damages arising from your use of the app.",
    },
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.intro}>
        Welcome to PetPass! By using our app, you agree to comply with and be
      ...
      <p className={styles.conclusion}>
        By using PetPass, you acknowledge that you have read, understood, and
        agree to these Terms of Service. If you have any questions, please
        contact us at <strong>not@avaliable.yet</strong>.
      </p>
    </div>
  );
}
