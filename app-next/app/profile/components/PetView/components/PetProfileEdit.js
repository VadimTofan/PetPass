    ...
    >
      <header className={styles.pet__header}>
        <div className={styles.pet__avatarWrap}>
          <Image src={draft?.photo_url || "/images/loading.svg"} alt={draft?.name || "Loading"} width={160} height={160} className={styles.pet__avatar} priority />
        </div>
        <div className={styles.pet__headerInfo}>
          <input className={styles.pet__nameInput} type="text" value={draft.name} onChange={(e) => setDraft({ ...draft, name: e.target.value })} required />
          <input className={styles.pet__nameInput} type="text" value={draft.species} onChange={(e) => setDraft({ ...draft, species: e.target.value })} required />
        </div>
