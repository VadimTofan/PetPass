  ...
  return (
    <main className={styles.contact}>
      <header className={styles.contact__header}>
        ...
        <p className={styles.contact__lead}>You are welcome to contact us using the form on the right. We will reply as soon as possible.</p>
      </header>
      ...
      <section className={styles.contact__grid}>
            ...
            <ul className={styles.social__list} aria-label="Social media links">
              <li className={styles.social__item}>
                <a href="#" aria-label="Facebook" className={styles.social__link}>
                  <Image src="/icons/facebook.svg" width={20} height={20} alt="Facebook" className={styles.social__icon} />
                </a>
              </li>
              <li className={styles.social__item}>
                <a href="#" aria-label="LinkedIn" className={styles.social__link}>
                  <Image src="/icons/linkedin.svg" width={20} height={20} alt="LinkedIn" className={styles.social__icon} />
                </a>
              </li>
              <li className={styles.social__item}>
                <a href="#" aria-label="Instagram" className={styles.social__link}>
                  <Image src="/icons/instagram.svg" width={20} height={20} alt="Instagram" className={styles.social__icon} />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className={`${styles.contact__panel} ${styles.contact__panelElevated}`}>
          <div className={styles.contact__petsWrapper} aria-hidden="true">
            <Image src="/images/pets.png" alt="" width={800} height={800} className={styles.contact__pets} />
          </div>
